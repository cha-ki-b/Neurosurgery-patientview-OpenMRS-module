...
public class AntecedentsPageController {
    ...
    public void controller(PageModel model, @org.springframework.web.bind.annotation.RequestParam("patientId") String patientUuid) {
        ...
        model.addAttribute("medicalHistory", service.getMedicalHistory(patient));
        model.addAttribute("surgicalHistory", service.getSurgicalHistory(patient));
        model.addAttribute("admissionContexts", service.getAdmissionContexts(patient));
    }
}
