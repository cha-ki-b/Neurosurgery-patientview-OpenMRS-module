...
public class EvolutionPageController {
    ...
    public void controller(PageModel model, @org.springframework.web.bind.annotation.RequestParam("patientId") String patientUuid) {
        ...
        model.addAttribute("postopEvolutions", service.getPostopEvolutions(patient));
        model.addAttribute("sequelae", service.getSequelae(patient));
    }
}
