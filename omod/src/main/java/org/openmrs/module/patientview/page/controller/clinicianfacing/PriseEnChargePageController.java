...
public class PriseEnChargePageController {
    ...
    public void controller(PageModel model, @org.springframework.web.bind.annotation.RequestParam("patientId") String patientUuid) {
        ...
        model.addAttribute("medicalTreatments", service.getMedicalTreatments(patient));
        model.addAttribute("surgicalTreatments", service.getSurgicalTreatments(patient));
    }
}
